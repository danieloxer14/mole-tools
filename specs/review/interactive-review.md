...
| `POST /api/progress`                                 | Persist a layer `done` toggle and/or a viewed-file change, returning only updated `layers` and `viewedFiles`; it does not refresh host-derived state.                                                                                                                                                                                                                                                 |
