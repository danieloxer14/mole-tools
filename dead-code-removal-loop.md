...
- [ ] `dead-code/review-ui-unused-helper-exports.md` — Needs investigation — 2026-08-30 — no code changed; baseline focused 9/0 and full 436/0 had no assertion failures but exited on enforced 90% coverage thresholds (focused 24.13% funcs / 48.64% lines; full 85.12% funcs / 88.92% lines); build and lint passed; exact missing evidence recorded in ticket.
